...
<head>
  ...
  <title>Boolaraga - @yield('title')</title>
  <link rel="shortcut icon" href="{{ asset('img/boolaraga.jpg') }}">
      ...
      <div class="container">
        <a class="title" href="{{ url('/') }}">
          <div class="title-icon rotate-n-15">
            <i class="fas fa-boolaraga-alt"></i>
          </div>
          <div class="title-text mx-3">Boolaraga</div>
        </a>
        <!-- Topbar Navbar -->
