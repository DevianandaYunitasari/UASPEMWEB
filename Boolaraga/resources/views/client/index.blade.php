    ...
    <div class="card shadow">
      <div class="card-body">
        <form method="POST" action="{{ route('store') }}" class="user">
          ...
          <div class="form-group">
            <label for="end">Waktu Berakhir</label><br>
            <select class="select2 form-control" id="end" name="end" required>
              <option value="" disabled selected>-- Pilih Waktu Berakhir --</option>
          ...
          <div class="form-group">
            <label for="fasilitas">Tanggal Pesan</label>
            <input type="date" class="form-control" id="fasilitas" name="fasilitas" required />
          </div>
