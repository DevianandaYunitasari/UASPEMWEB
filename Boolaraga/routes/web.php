...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['pelanggan'])->group(function () {
        Route::get('/pesan/{antri}/{data}', [App\Http\Controllers\PemesananController::class, 'pesan'])->name('pesan');
        Route::get('/cari/antri/{data}', [App\Http\Controllers\PemesananController::class, 'edit'])->name('cari.antri');
